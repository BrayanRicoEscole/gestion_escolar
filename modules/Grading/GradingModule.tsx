...
const GradingModule: React.FC = () => {
  ...
  const renderContent = () => {
    switch (admin.currentStep) {
      ...
      case 5: return <Step5Moments year={admin.schoolYear!} setYear={admin.setSchoolYear} stationIdx={admin.selectedStationIdx} onSelectStation={admin.setSelectedStationIdx} total={admin.validations.momentTotal} onAdd={admin.addMoment} onRemove={admin.removeMoment} onCopyFrom={(sourceIdx) => admin.copyStationStructure(sourceIdx, admin.selectedStationIdx)} />;
